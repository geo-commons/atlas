var map, vectorSource, vectorLayer, panorama, cql_filter;

// een test voor de streetview branch
...
function init(){
	...
	layerList.forEach(function(layer, i) {
		...
		if(layer.get('isgeojson')){
			...
			//var linkSrc = "https://datalab.purmerend.nl:8443/geoserver/topp/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER="+ layersName +"";
