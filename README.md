...
Atlas can work with any WFS server as a source of geospatial data. Therefore Geoserver is not listed as a requirement to set up a development environment. 
Datalab Purmerend relies on [Geoserver](https://github.com/geoserver/geoserver) for viewing geospatial data.
