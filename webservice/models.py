...
class Layer(models.Model):
    ...
    meta_name = models.CharField('Naam', max_length=128, null=True, blank=True)
    meta_kind = models.CharField('Soort', max_length=128, null=True, blank=True,
                                 help_text='Het is mogelijk om tekst op te maken met Markdown in dit veld')
    meta_org = models.CharField('Organisatie', max_length=128, null=True, blank=True,
                                help_text='Het is mogelijk om tekst op te maken met Markdown in dit veld')
    meta_updated = models.CharField(
        'Laatst bijgewerkt', max_length=128, null=True, blank=True,
        help_text='Het is mogelijk om tekst op te maken met Markdown in dit veld')

    ckan_url = models.URLField('CKAN metadata URL', null=True, blank=True, help_text='Haal metadata op via CKAN')
