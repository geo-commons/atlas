...
<img src="_images/kaartlagenmenu.png" alt="kaartlagenmenu" title="kaartlagenmenu" width="200" /> 
...
<img src="_images/keuzevandezichtbarekaartlagen.png" alt="Keuze van de zichtbare kaartlagen" title="Keuze van de zichtbare kaartlagen" width="200" /> 
...
<img src="_images/keuzevandezichtbarekaartlagen2.png" alt="Categorieën" title="Categorieën" width="260" />

Legenda
=======
![icoonzichtbarelagen](pics/icoonzichtbarelagen.png)
...
<img src="_images/legenda.png" alt="Legenda" title="Legenda" width="300" />  

Klik op het [Transparantie symbool](./help.md#zichtbaarheid-transparantie-opacity) Transparantie symbool om de transparantie van de kaartlaag in te stellen. Dit kan handig zijn wanneer meerdere kaartlagen geopend zijn en de zichtbaarheid van onderliggende kaartlagen groter moet zijn.  
...
![metadata](pics/toon-metadata.png)  
...
<img src="_images/meerinformatie.png" alt="Meer informatie" title="Meer informatie" width="300" />  
<img src="_images/meerinformatie2.png" alt="Metadata, meer informatie" title="Metadata, meer informatie" width="400" /> 
...
<img src="_images/zoek_lagen.png" alt="Zoek lagen" title="Zoek lagen" width="350" />
...
<img src="_images/zichtbaarheid.png" alt="Zichtbaarheid" title="Zichtbaarheid" width="350" />
...
<img src="_images/kimono.png" alt="Zoek adres" title="Zoek adres" width="350" />
...
<img src="_images/zoek-op-coordinaat.png" alt="Zoek op coördinaat" title="coördinaat" width="550" />
...
<img src="_images/rd-wgs84-projectie.png" alt="RD naar WGS 84" title="RD naar WGS 84" width="550" />
...
![toondetails1](pics/toondetails1.png)

Met de Toon details knop kan het detail paneel ingeklapt en uitgeklapt worden.

<img src="_images/toondetails2.png" alt="Toon details" title="Toon details" width="350" />
...
<img src="_images/gekoppeldegegevens.png" alt="Gekoppelde gegevens bekijken" title="Gekoppelde gegevens bekijken" width="300" />
...
Met de knop Selecteer gebied kunnen objecten binnen een vlak gezocht worden. Zoeken kan alleen op zichtbare lagen.

<img src="_images/objectenselecteren.png" alt="Objecten selecteren" title="Objecten selecteren" width="200" />



Teken een vlak in de kaart.

![tekeneenvlak](pics/tekeneenvlak.png)

De objecten die zich binnen dit vlak bevinden worden weergegeven in het datapaneel.

![objectenbinnenditvlak](pics/objectenbinnenditvlak.png)
...
![rondkijkfoto](pics/rondkijkfoto.png)
...
<img src="_images/externe_viewer.png" alt="Externe viewer selecteren" title="Externe viewer selecteren" width="200" />
...
![panorama-groot-sluit](pics/panorama-groot-sluit.png)
...
![rondkijkfoto2](pics/rondkijkfoto2.png)
...
![meten](pics/meten.png)

Tekenen
=======
<img src="_images/tekenknop.png" alt="tekensymbool" title="het tekensymbool" width="50" /> Met de tekenfunctie kunnen punten, lijnen en polygonen getekend worden. 
...
![zoekenopdata](pics/zoekenopdata.png)
...
<img src="_images/filters.png" alt="Filters activeren" title="Filters activeren" width="200" />
...
<img src="_images/filters1.png" alt="Filters configureren" title="Filters configureren" width="800" />
...
<img src="_images/afdrukken.png" alt="afdrukken" title="afdrukken" width="400" /> 
...
<img src="_images/extra_instellingen.png" alt="extra instellingen" title="extra instellingen" width="150" /> 
...
<img src="_images/loginscherm.png" alt="Loginscherm" title="Loginscherm" width="150" />

Klik rechtsboven in het Atlas-scherm op de drie verticale puntjes om het optiemenu met de loginkeuze te tonen.

![externe_inlog](pics/externe_inlog.png)
