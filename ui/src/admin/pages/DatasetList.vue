  ...
  <div class="container __admin">
    <div class="flex flex-row items-center justify-between w-full py-8">
      ...
      <div class="top-menu-button-container">
        ...
        <Button class="text-md" type="submit" @click="() => openFormModal('newDataset')">
    ...
    <div class="admin-content-wrapper">
      ...
      <div v-if="advanceSettings" class="flex flex-col gap-2">
        ...
        <span class="text-sm">{{ selectedRowsDisplayText }}</span>
      </div>
