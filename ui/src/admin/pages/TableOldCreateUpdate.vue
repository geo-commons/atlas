...
export default {
  ...
  methods: {
    async getTable() {
      const result = await fetch(`/atlas/api/v1/tables_old/${this.$route.params.id}/`, {
    ...
    async saveTable(currentValues, continueEditing = false) {
      const url = `/atlas/api/v1/tables_old/${this.$route.params.id}/`;
        ...
        access: {
          ...
          questions: [
            ...
            },
            {
              ...
              type: "checkbox",
              required: false,
              infoText: "De inhoud van deze tabel kan alleen bekeken worden door ingelogde gebruikers.",
            },
          ],
        },
      };
