<template>
  <vee-form :initial-values="currentValues" @submit="save">
    ...
    <div class="config-btn-wrapper">
      ...
      <button v-if="createView" class="button __primary" type="button">Opslaan en openen</button>
    </div>
  </vee-form>
</template>
...
export default {
  ...
  methods: {
    ...
    save(values, continueEditing = false) {
      console.log(values, continueEditing);
      if (this.createView) {
        this.objectSpecificSave(values, continueEditing);
      } else {
