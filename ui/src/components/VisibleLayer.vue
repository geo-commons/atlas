<template>
  <li class="layer-wrapper">
    <div class="header">
      ...
      <button class="iconbutton" :class="{ isActive: showSlider}" aria-label="Toon doorzichtigheid schuifregelaar" @click="toggleSlider">
      ...
      <button class="iconbutton" aria-label="Verberg laag" @click="toggleLayer">
