  ...
  <vue-tippy placement="left-end" theme="popover" trigger="click" :distance="8" :delay="[0, 0]" :a11y="false">
      ...
      <button :class="{ iconbutton: true, showAlways: showAlways }" aria-label="Toon meer informatie">
        ...
        >
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="info_black_18dp" transform="translate(-1.000000, -1.000000)" fill="#000000" fill-rule="nonzero">
              <path
                id="Shape"
    ...
    <div class="container">
      <div class="heading">
        ...
        <div v-if="layer.metadata.lineage" class="description">
      ...
      <div v-if="layer.metadata.organization" class="properties">
        <div class="property">
