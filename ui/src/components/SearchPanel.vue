  ...
  <div class="wrapper" v-if="showSearchPanel">
    <div class="search-wrapper">
      <form class="search" autocomplete="off" method="GET" @submit="onSearch">
        ...
        <div class="buttons">
          <button class="iconbutton search-button" type="submit" :disabled="!this.query" aria-label="Zoek">
          ...
          <button v-if="showInfoPanel" type="button" class="iconbutton clear-button" @click="clearPosition" aria-label="Wis positie">
