<template>
  <SidePanel :showPanel="showInfoPanel" :hasFeaturedImage="hasFeaturedImage">
    <template v-slot:search>
      <button class="iconbutton close-button" :class="{shadow:hasFeaturedImage}" type="button" v-tippy='{ placement : "right" }' content="Sluit paneel" aria-label="Sluit paneel" @click="closeInfoPanel">
