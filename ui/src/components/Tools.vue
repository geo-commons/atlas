  ...
  <div class="wrapper">
    <div class="buttons" :class="{ showMeasureMenu }">
      <button class="iconbutton" :class="{ isActive: tool === 'SELECT_AREA' }" @click="toggleSelectArea" v-tippy='{ placement : "bottom" }' content="Selecteer gebied" aria-label="Selecteer gebied">
        <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg"><path d="M14 2h-2V0h2v2zm-2 16h2v-2.59L16.59 18 18 16.59 15.41 14H18v-2h-6v6zm4-12h2V4h-2v2zm0 4h2V8h-2v2zm-8 8h2v-2H8v2zM4 2h2V0H4v2zM0 14h2v-2H0v2zm2 4v-2H0c0 1.1.9 2 2 2zM16 0v2h2c0-1.1-.9-2-2-2zM8 2h2V0H8v2zM0 6h2V4H0v2zm4 12h2v-2H4v2zm-4-8h2V8H0v2zm0-8h2V0C.9 0 0 .9 0 2z" fill="currentColor" fill-rule="nonzero"/></svg>
      </button>
