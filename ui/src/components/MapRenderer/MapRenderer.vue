    ...
    <div v-show="!showDataPanel || !showDataPanelFullScreen" class="ui-container">
      ...
      <div class="bottom-left-panels" :class="{ 'bottom-panels-padding': compareLayers || mapStore.timeSlider }">
        <LayersPanel
          ...
          :show-compare-slider="compareLayers"
          :show-toggle-all-layers-in-legend="features.show_toggle_all_layers_in_legend !== false"
          :show-sort-layers-in-legend="features.show_sort_layers_in_legend !== false"
          :show-transparency-in-legend="features.show_transparency_in_legend !== false"
          :show-not-selectable-in-legend="features.show_not_selectable_in_legend !== false"
          :show-information-in-legend="features.show_information_in_legend !== false"
  ...
  watch: {
    ...
    "mapStore.layerFilters": {
      handler() {
        ...
        this.getFeatureInfo(this.position);
      },
      deep: true,
    },
